...
namespace Game
{
     abstract class Islemler //Burda abstract sınıfı kullandım çünkü kampanya sınıfımda da aynı işlemleri tekrarlıcaktım tekrarlamamak için abstract sınıfıa almış bulunmaktayım.
    {
